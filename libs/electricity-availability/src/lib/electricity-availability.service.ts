            ...
            if (!referenceTime) {
              ...
              if (latest.is_available) {
                ...
                if (absDiff <= 30) {
                  ...
                  scheduleContextMessage = '💡 Світло повернулось раніше, ніж за графіком!';
                }
              } else {
                // Факт: ВИМКНУЛИ
                if (absDiff <= 30) {
                  ...
                  scheduleContextMessage = '💡 Світло було довше, ніж за графіком!';
                  if (diffInMinutes > 120) {
                    scheduleContextMessage = '🚨 Ймовірно аномалія/екстрене втручання — вимкнення відбулося значно пізніше.';
                  }
                } else {
